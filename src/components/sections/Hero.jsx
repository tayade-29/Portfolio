                ...
                <div
                    ...
                    <div className="space-y-2 max-w-4xl mx-auto">
                        <div className="flex justify-between items-start">
                            {/* Left Section (Title, Subtitle, Secondary Text) */}
                            <div className="flex-1 space-y-4">
                                ...
                                <AnimatedSubtitle
                                    text={headlines[1]}
                                    className="text-secondary-text text-2xl md:text-3xl font-bold break-words mx-auto w-[600px] max-w-full"
                                />
                                ...
                                <motion.p
                                    ...
                                    className="text-secondary-text text-xl md:text-2xl font-medium break-words w-[600px] max-w-full mt-4">
                                    {headlines[2]}
                                </motion.p>
                            </div>
                            ...
                            <motion.div
                                ...
                                <img
                                    src={profile}
                                    alt="Profile"
                                    className='rounded-full border-2 border-secondary transform translate-x-10 w-60 h-50'
                                />
                            </motion.div>
                        </div>
